...
import org.apache.hadoop.security.proto.RefreshCheckUserPasswordProtocolProtos.RefreshCheckUserPasswordProtocolService;
...
class NameNodeRpcServer implements NamenodeProtocols {
    ...
    public NameNodeRpcServer(Configuration conf, NameNode nn)
        ...
        BlockingService refreshCheckUserPasswordService = RefreshCheckUserPasswordProtocolService.newReflectiveBlockingService(refreshCheckUserPasswordXlator);
        ...
        if (serviceRpcAddr != null) {
            ...
            DFSUtil.addPBProtocol(conf, RefreshCheckUserPasswordProtocolPB.class,
                    refreshCheckUserPasswordService, serviceRpcServer);
        ...
        DFSUtil.addPBProtocol(conf, RefreshCheckUserPasswordProtocolPB.class,
                refreshCheckUserPasswordService, clientRpcServer);
